...
public final class PseudoNotFoundReader implements Reader<PseudoNotFoundReader.PseudoNotFound>,Trame {
  
    public record PseudoNotFound(String pseudoDst, String message) {
    ...
    public ProcessStatus process(ByteBuffer buffer) {
        ...
        value = new PseudoNotFound(pseudoDst, message);
        return ProcessStatus.DONE;
    }

    @Override
    public PseudoNotFound get() {
        if (state != State.DONE) {
            throw new IllegalStateException();
        }
        return value;
